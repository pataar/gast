...
func runConfigure(cmd *cobra.Command, args []string) error {
	...
	// Step 5: Validate the token by calling the GitLab API.
	...
	content := buildTOML(host, token, interval, pageSize)
...
func buildTOML(host, token, interval string, pageSize int) string {
